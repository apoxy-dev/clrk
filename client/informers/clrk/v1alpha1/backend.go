...
type BackendInformer interface {
	...
	Lister() clrkv1alpha1.BackendLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClrkV1alpha1().Backends(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClrkV1alpha1().Backends(namespace).Watch(context.TODO(), options)
			},
		},
		&apiclrkv1alpha1.Backend{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiclrkv1alpha1.Backend{}, f.defaultInformer)
}

func (f *backendInformer) Lister() clrkv1alpha1.BackendLister {
	return clrkv1alpha1.NewBackendLister(f.Informer().GetIndexer())
}
