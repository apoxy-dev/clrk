...
type WorkerPoolInformer interface {
	...
	Lister() clrkv1alpha1.WorkerPoolLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClrkV1alpha1().WorkerPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClrkV1alpha1().WorkerPools(namespace).Watch(context.TODO(), options)
			},
		},
		&apiclrkv1alpha1.WorkerPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workerPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiclrkv1alpha1.WorkerPool{}, f.defaultInformer)
}

func (f *workerPoolInformer) Lister() clrkv1alpha1.WorkerPoolLister {
	return clrkv1alpha1.NewWorkerPoolLister(f.Informer().GetIndexer())
}
